...
var usersArr = [].concat(_toConsumableArray(users));
...
.then(function (data) {
    ...
    globalResponseJson.users.map(function (user) {
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function groupEvent(arr, event, fn) {
        arr.forEach(function (child) {
            return child.addEventListener(event, fn);
        });
    }
    ...
    function userClicked(clickedUser) {
        ...
        var user = globalResponseJson.users.filter(function (user) {
